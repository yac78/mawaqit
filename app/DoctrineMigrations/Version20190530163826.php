...
final class Version20190530163826 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('update configuration set timezone_name = \'America/Toronto\' where id in (select configuration_id from mosque where country = \'CA\')');
        ...
        $this->addSql('update configuration set timezone_name = \'America/New_York\' where id in (select configuration_id from mosque where country = \'US\')');
