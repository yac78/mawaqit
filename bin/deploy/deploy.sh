...
cp ~/perso/projects/prayer-times/app/config/parameters.prod.yml /tmp/prayer-times-v3/app/config/parameters.prod.yml

mkdir -p ~/www/prayer-times-v3/$1

rsync -r --files-from=bin/deploy/files-to-package --exclude-from=bin/deploy/files-to-exclude /tmp/prayer-times-v3/ ~/www/prayer-times-v3/$1/
