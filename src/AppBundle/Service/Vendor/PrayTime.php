...
namespace AppBundle\Service\Vendor;
...
class PrayTime
{
    ...
    // Juristic Methods
    var $Shafii     = 'Shafii';    // Shafii (standard)
    var $Hanafi     = 'Hanafi';    // Hanafi

    // Adjusting Methods for Higher Latitudes
    var $None       = 0;    // No adjustment
    var $MidNight   = 'MidNight';    // middle of night
    var $OneSeventh = 'OneSeventh';    // 1/7th of night
    var $AngleBased = 'AngleBased';    // angle/60th of night
    ...
    */
    ...
    function PrayTime($methodID = 'MWL')
    {

        $this->methodParams['Jafari']    = array(16, 0, 4, 0, 14);
        $this->methodParams['Karachi']   = array(18, 1, 0, 0, 18);
        $this->methodParams['ISNA']      = array(15, 1, 0, 0, 15);
        $this->methodParams['MWL']       = array(18, 1, 0, 0, 17);
        $this->methodParams['UOIF']      = array(12, 1, 0, 0, 12);
        $this->methodParams['Makkah']    = array(18.5, 1, 0, 1, 90);
        $this->methodParams['Egypt']     = array(19.5, 1, 0, 0, 17.5);
        $this->methodParams['Tehran']    = array(17.7, 0, 4.5, 0, 14);
        $this->methodParams['Custom']    = array(18, 1, 0, 0, 17);

        $this->setCalcMethod($methodID);
    }

    function __construct($methodID = 'MWL')
    {
    ...
    {
        $methodID = $methodID === 'Standard' ? 0 : 1;
